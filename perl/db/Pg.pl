...
'ipodtranscode.1'               => "SELECT foltia_subtitle.pid, foltia_subtitle.tid, foltia_subtitle.m2pfilename, filestatus, foltia_program.aspect, foltia_subtitle.countno, foltia_program.title, foltia_subtitle.subtitle, foltia_subtitle.startdatetime, foltia_subtitle.enddatetime, foltia_subtitle.lengthmin FROM foltia_subtitle, foltia_program, foltia_m2pfiles WHERE filestatus >= ? AND filestatus < ? AND foltia_program.tid = foltia_subtitle.TID AND foltia_program.PSP = 1 AND foltia_m2pfiles.m2pfilename = foltia_subtitle.m2pfilename ORDER BY filestatus ASC, enddatetime ASC LIMIT 1",
