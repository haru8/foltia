...
#config section
$toolpath = '/usr/local/apps/foltia'; #「perl」ディレクトリがあるPATH
$recunits = 0;					#アナログキャプチャカード搭載エンコーダの数
$recfolderpath = '/usr/local/apps/foltia/php/tv';		#録画ファイルを置くPATH
...
$haveirdaunit = 0;#Tira-2<http://www.home-electro.com/tira2.php>をつないでいるときに1,なければ0
...
## for sqlite
$main::DSN="dbi:SQLite:dbname=/usr/local/apps/foltia/foltia.sqlite";
