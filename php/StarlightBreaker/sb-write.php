...
$blogtitle = stripslashes(mb_convert_encoding(urldecode($_POST[subjects]), "UTF-8"));
//$blogtitle =  stripslashes(urldecode($_POST[subjects]));
$blogmessages = stripslashes(mb_convert_encoding(urldecode($_POST[maintext]), "UTF-8"));
...
$htmloutput =  mb_convert_encoding("$htmloutput","UTF-8");
print "$htmloutput";
...
$blogmessages =  mb_convert_encoding($blogmessages, "UTF-8");
print "$blogmessages <br />\n";
