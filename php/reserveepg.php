...
if (! $chkoverwrap) {
    ...
    if ($sumCount > 1) {
        print "<tr><td style=\"border-top:dotted 1px #AAA; border-right:none;\"></td><td style=\"border-top:dotted 1px #AAA; border-right:none;\"></td><td style=\"border-top:dotted 1px #AAA; border-right:none;\"></td><td style=\"border-top:dotted 1px #AAA; border-right:none;\"></td><td style=\"text-align:right\">合計</td><td style=\"border-top:dotted 1px #AAA;\">$lengthminSum</td></tr>";
    }
    print "</table>";
